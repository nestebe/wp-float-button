                        ...
                        >
                            <template v-if="action.tooltip">
                                <li v-if="toggle" :style="{ 'background-color': action.color || bgColor }"
                                    ...
                                    @click="doAction(action.dataBtn)" class="pointer"
                                    ref="actions">
...
export default {
  ...
  methods: {
    doAction(btnData) {
      ...
      switch (btnData.type) {
        case "url":
          window.open(btnData.content, btnData.openOption);
          break;
        case "tel":
          window.open("tel:" + btnData.content);
          break;
        case "email":
          window.open("maito:" + btnData.content);
          break;
        default:
          window.open(btnData.link, btnData.content);
      }
    },
    tooltipPos() {
